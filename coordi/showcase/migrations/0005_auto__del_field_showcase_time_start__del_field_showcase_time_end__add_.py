...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Showcase.time_start'
        db.delete_column('showcase_showcase', 'time_start')

        # Deleting field 'Showcase.time_end'
        db.delete_column('showcase_showcase', 'time_end')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Showcase.time_start'
        db.add_column('showcase_showcase', 'time_start', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2012, 1, 5)), keep_default=False)

        # Adding field 'Showcase.time_end'
        db.add_column('showcase_showcase', 'time_end', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2012, 1, 5)), keep_default=False)
    ...
    models = {
        ...
        'base.photo': {
            ...
            'photo_id': ('django.db.models.fields.CharField', [], {'default': "'7174e616d8fd5b59f498c1a6ff7b8579'", 'max_length': '32', 'primary_key': 'True'})
        },
        ...
        'showcase.album': {
            ...
            'album_id': ('django.db.models.fields.CharField', [], {'default': "'3f5d3ba2dfb519bedee6bf731cdd6547'", 'max_length': '32', 'primary_key': 'True'}),
        ...
        'showcase.entry': {
            ...
            'entry_id': ('django.db.models.fields.CharField', [], {'default': "'8d9f2f141a03882f9fbd61de4b76525a'", 'max_length': '32', 'primary_key': 'True'}),
        ...
        'showcase.showcase': {
            ...
            'showcase_id': ('django.db.models.fields.CharField', [], {'default': "'f55f9121af1c01cdac962f0972bb656a'", 'max_length': '32', 'primary_key': 'True'}),
        ...
        'showcase.theme': {
            ...
            'theme_id': ('django.db.models.fields.CharField', [], {'default': "'7c3438c590592978f13630002074eab9'", 'max_length': '32', 'primary_key': 'True'}),
